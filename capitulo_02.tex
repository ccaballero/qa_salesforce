...
\item \textbf{Pruebas de aceptación}, para las funcionalidades de tipo CRUD en
    ...
    eliminación.
\item \textbf{Pruebas funcionales}, para todos los elementos que estan provistos
...
\begin{tikzpicture}[
    ...
    \node {Productos}
        ...
        child { node {Crear entrada del catálogo de precios}
            ...
            child { node {Utilizar precio estandar}}
        }
        child [missing] {}
        child [missing] {}
        child [missing] {}
...
\begin{tikzpicture}[
    ...
    \node {Listas de precios}
        ...
        child { node {Crear lista de precios}
            ...
            child { node {Es lista de precios estandar}}
        }
        child [missing] {}
        child [missing] {}
        child [missing] {}
        ...
        child [missing] {}
        child { node {Agregar productos}
            child { node {Buscar entrada de catalogos de precios}}
        };
\end{tikzpicture}
...
\begin{tikzpicture}[
    ...
    \node {Vista de lista}
        ...
        child [missing] {}
        child [missing] {}
        child { node {Agregar logica de filtro}
