...
\hline
\footnotesize{\textbf{Herramienta}} & \footnotesize{\textbf{Descripción}} \\
\hline
\footnotesize{\emph{XMind}} & \footnotesize{Herramienta para la elaboración de los mapas mentales.} \\
\footnotesize{\emph{GitHub}} & \footnotesize{Servicio de almacenamiento y versionado de código fuente y documentación.} \\
\footnotesize{\emph{Testlink}} & \footnotesize{Herramienta basada en web que facilita el proceso de gestión de calidad de software.} \\
\footnotesize{\emph{LambdaTest}} & \footnotesize{Herramienta basada en web para realizar la evaluación de compatibilidad en navegadores.} \\
\footnotesize{\emph{Postman}} & \footnotesize{Herramienta para la solicitud de peticiones HTTP para el uso de API.} \\
\hline
\end{tabular}
...
\multirow{3}{4.0cm}{Banco de pruebas de evaluación del modulo de productos.} \\
\cline{3-3}
...
\multirow{3}{4.0cm}{Banco de pruebas de evaluación del modulo de listas de precios.} \\
\cline{3-3}
...
\multirow{3}{4.0cm}{Banco de pruebas de localización, compatibilidad, y soportabilidad.} \\
\cline{3-3}
...
\multirow{3}{4.0cm}{Banco de pruebas automatizadas sobre el API disponible.} \\
\cline{3-3}
...
\item [HTSM] Documento de describe los elementos necesarios para la creación de
    pruebas.
\item [Banco de casos de prueba] Conjunto de casos de prueba a diseñar y
...
error y demás componentes, se realizarán las siguientes evaluaciones, estas
serán similares para los otros módulos evaluados.
...
Similarmente a los dos módulos anteriores, también se realizarán las siguientes
evaluaciones:
