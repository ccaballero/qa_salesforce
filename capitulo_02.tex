...
\begin{table}
\centering
\begin{tabular}{|p{4.0cm}|p{2.0cm}|p{2.0cm}|p{2.0cm}|p{2.0cm}|p{2.0cm}|}
\hline
...
Se considero la interfaz \emph{Lightning Experience}, como el objetivo de la
nueva interface, se ha escogido unicamente esta interfaz novedosa como unico
objetivo de la evaluación.

La versión \emph{Lightning Experience} esta disponible para las siguientes
ediciones del producto: \emph{Essentials}, \emph{Group},
...
\begin{tikzpicture}[
    ...
    \node {Productos}
        child [missing] {}
        child { node {Filtar por: Vista de Lista}}
        child { node {Nuevo}}
...
\caption{Interfaz grafica para el módulo de listas de precios.}
...
\begin{tikzpicture}[
    ...
    \node {Controles de Vista de Lista}
        ...
        child { node {Eliminar}}
        child { node {Reestablecer anchuras de columna}};
\end{tikzpicture}
\caption{Funciones que componen el módulo de gestión de listas de precios.}
